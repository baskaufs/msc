...
<a href="http://rs.tdwg.org/dwc/terms/#scientificName" class="external text">dwc:scientificName</a>
...
taxa should be given in [Taxon
Count](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Taxon_Count)
(see below). If possible, avoid repeating the [Taxonomic
Coverage](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Taxonomic_Coverage)
...
given in [Scientific Taxon
Name](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Scientific_Taxon_Name).

Defined by:

<a href="http://rs.tdwg.org/dwc/terms/#identificationQualifier" class="external text">dwc:identificationQualifier</a>

Notes:

Splitting identification qualification and [Scientific Taxon
Name](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Scientific_Taxon_Name)
into separate fields is recommended practice in cases where only a
single taxon name is available, or if the exchange format is able to
keep relations between multiple names and identification qualifiers.
Where the exchange format only supports simple multiplicities, a media
item with multiple [Scientific Taxon
Names](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Scientific_Taxon_Name),
some with, some without identification qualifiers, may have to be
transferred with "cf." or "aff." qualifiers remaining embedded in the
[Scientific Taxon
Name](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Scientific_Taxon_Name).

For discussion of Darwin Core usage see
<a href="http://code.google.com/p/darwincore/wiki/Identification" class="external text">here</a>.

Example: For the determinations “cf. Fusarium oxysporum f. sp.
palmarum”, “Fusarium cf. oxysporum f. sp. palmarum”, “Fusarium oxysporum
cf. f. sp. palmarum” the Scientific Taxon Name would always be “Fusarium
oxysporum f. sp. palmarum”, with Identification Qualifier “cf. genus”,
“cf. species” and “cf. f.sp.”, respectively. In most cases only the
lowest taxon is in doubt, but cases exist where good reasons exist to
suspect a specific or even infraspecific determination, without having a
save generic identification.
...
<a href="http://rs.tdwg.org/dwc/terms/#vernacularName" class="external text">dwc:vernacularName</a>
...
<a href="http://rs.tdwg.org/dwc/terms/#nameAccordingTo" class="external text">dwc:nameAccordingTo</a>
...
<a href="http://rs.tdwg.org/dwc/terms/#nameAccordingTo" class="external text">dwc:nameAccordingTo</a>
is: 'The reference to the source in which the specific taxon concept
...
See
<a href="http://rs.tdwg.org/dwc/terms/#scientificNameID" class="external text">dwc:scientificNameID</a>
and also the
<a href="http://code.google.com/p/darwincore/wiki/Taxon" class="external text">DwC Taxon attributes</a>.
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#otherScientificName)
...
multiple [Scientific Taxon
Names](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Scientific_Taxon_Name)
are given, the association between synonyms and names may not be
deducible from the AC record alone.
...
Name](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Scientific_Taxon_Name)
to the media item or the occurrence represented in the media item.

Defined by:

<a href="http://rs.tdwg.org/dwc/terms/#identifiedBy" class="external text">dwc:identifiedBy</a>
...
By](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Identified_By)
applied a [Scientific Taxon
Name](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Scientific_Taxon_Name)
to the resource.

Defined by:

<a href="http://rs.tdwg.org/dwc/terms/#dateIndentified" class="external text">dwc:dateIndentified</a>
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#taxonCount)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#subjectPart)

Notes:

No formal encoding scheme as yet exists. Examples are "whole body",
"head", "flower", "leaf", "canopy" (of a rain forest stand). Several
anatomical ontologies are emerging in
<a href="http://www.obofoundry.org/" class="uri external free">http://www.obofoundry.org/</a>
...
<a href="http://rs.tdwg.org/dwc/terms/#sex" class="external text">dwc:sex</a>
...
<a href="http://rs.tdwg.org/dwc/terms/#lifeStage" class="external text">dwc:lifeStage</a>
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#subjectOrientation)
...
<a href="http://rs.tdwg.org/dwc/terms/#preparations" class="external text">dwc:preparations</a>
...
[Resource Creation
Technique](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Resource_Creation_Technique)
for technical aspects of digital media object creation.
...
shown. It is recommended that the [Location
Shown](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Location_Shown)
...
[Location
Created](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Location_Created)
should be used to maintain information accuracy. When one but not both
of these locations are present, AC is silent about whether the provided
one entails the other. A best practices document for a particular AC
implementation might address this.
...
Date and
Time](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Original_Date_and_Time)
found in the [Temporal Coverage
Vocabulary](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Temporal_Coverage_Vocabulary).
The date and time must comply with the World Wide Web Consortium
(<a href="http://www.w3.org/" class="external text">W3C</a>)
<a href="http://www.w3.org/TR/NOTE-datetime" class="external text">datetime practice</a>,
which requires that date and time representation correspond to ISO
8601:1998, but with year fields always comprising 4 digits. This makes
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#digitizationDate)
...
(2010)<sup>[\[9\]](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_note-MWG2010-9)</sup>,
which has best practice advice on handling time-zone-less EXIF date/time
data. See also the
<a href="http://en.wikipedia.org/wiki/ISO_8601" class="external text">wikipedia IS0 8601 entry</a>
for further explanation and examples.
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#captureDevice)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#resourceCreationTechnique)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#IDofContainingCollection)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#relatedResourceID)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#providerID)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#derivedFrom)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#associatedSpecimenReference)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#associatedObservationReference)
...
[hasServiceAccessPoint](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#hasServiceAccessPoint),
whose label is simply "Service Access Point." Note that it is possible
for an implementation to use syntactic conventions that avoid direct use
of hasServiceAccessPoint, as illustrated in the final example in the
section
**[Multiplicity/Cardinality](https://terms.tdwg.org/wiki/Audubon_Core_Structure#Multiplicity.2FCardinality "Audubon Core Structure")**
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#accessURI)
...
<a href="http://purl.org/dc/elements/1.1/format" class="external text">dc:format</a>
...
<a href="http://dublincore.org/documents/dcmi-terms/#terms-format" class="external text">dcterms:format</a>

Notes:

See
<a href="http://wiki.dublincore.org/index.php/User_Guide/Publishing_Metadata#dcterms:format" class="external text">DCMI User_Guide</a>
for examples. **See also** the entry for
[**dc:format**](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#dc:format)
in this document and see the
**<a href="http://wiki.dublincore.org/index.php/FAQ/DC_and_DCTERMS_Namespaces" class="external text">DCMI FAQ on DC and DCTERMS Namespaces</a>**
for discussion of the rationale for terms in two namespaces. Normal
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#variantLiteral)
...
[This item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#variant)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#variantDescription)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#furtherInformationURL)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#licencingException)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#serviceExpectation)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#hashFunction)
...
[This
item.](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#hashValue)
...
of the [Hash
Function](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#Hash_Function)
term, using one of the standard literals from the Notes there.
...
Terms for Adobe XMP have URIs that are not resolvable. Instead, visit
<a href="http://www.adobe.com/content/dam/Adobe/en/devnet/xmp/pdfs/XMPSpecificationPart2.pdf" class="external text">, XMP Specification Part 2, Sec 3.4.2</a>
for further documentation.
...
1.  <span id="cite_note-1"><span class="mw-cite-backlink">[<span
    class="cite-accessibility-label">Jump up
    </span>↑](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_ref-1)</span>
    <span class="reference-text">NASA Global Change Master Directory
    <a href="http://gcmd.nasa.gov/" class="uri external free">http://gcmd.nasa.gov/</a></span></span>
2.  <span id="cite_note-2"><span class="mw-cite-backlink">[<span
    class="cite-accessibility-label">Jump up
    </span>↑](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_ref-2)</span>
    <span class="reference-text">Subject Categories defined in Key to
    Nature:
    <a href="http://www.keytonature.eu/wiki/Subject_Category" class="uri external free">http://www.keytonature.eu/wiki/Subject_Category</a>
    </span></span>
3.  <span id="cite_note-3"><span class="mw-cite-backlink">[<span
    class="cite-accessibility-label">Jump up
    </span>↑](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_ref-3)</span>
    <span class="reference-text">BioComplexity Thesaurus
    <a href="http://thesaurus.nbii.gov/" class="external free">http://thesaurus.nbii.gov</a></span></span>
4.  <span id="cite_note-4"><span class="mw-cite-backlink">[<span
    class="cite-accessibility-label">Jump up
    </span>↑](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_ref-4)</span>
    <span class="reference-text"> GBIF Description Types
    <a href="http://rs.gbif.org/vocabulary/gbif/description_type.xml" class="uri external free">http://rs.gbif.org/vocabulary/gbif/description_type.xml</a>
    </span></span>
5.  <span id="cite_note-5"><span class="mw-cite-backlink">[<span
    class="cite-accessibility-label">Jump up
    </span>↑](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_ref-5)</span>
    <span class="reference-text"> Species Profile Model
    (<a href="http://rs.tdwg.org/ontology/voc/SPMInfoItems.rdf" class="uri external free">http://rs.tdwg.org/ontology/voc/SPMInfoItems.rdf</a>
    </span></span>
6.  <span id="cite_note-6"><span class="mw-cite-backlink">[<span
    class="cite-accessibility-label">Jump up
    </span>↑](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_ref-6)</span>
    <span class="reference-text">Plinian Core
    (<a href="http://www.gbif.es/plinian/doku.php" class="uri external free">http://www.gbif.es/plinian/doku.php</a>)</span></span>
7.  <span id="cite_note-7"><span class="mw-cite-backlink">[<span
    class="cite-accessibility-label">Jump up
    </span>↑](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_ref-7)</span>
    <span class="reference-text">GEMET
    <a href="http://www.eionet.europa.eu/gemet" class="uri external free">http://www.eionet.europa.eu/gemet</a></span></span>
8.  <span id="cite_note-8"><span class="mw-cite-backlink">[<span
    class="cite-accessibility-label">Jump up
    </span>↑](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_ref-8)</span>
    <span class="reference-text">LTER Controlled Vocabulary
    <a href="http://vocab.lternet.edu/" class="uri external free">http://vocab.lternet.edu/</a>
    </span></span>
9.  <span id="cite_note-MWG2010-9"><span class="mw-cite-backlink">↑
    <sup>[<span
    class="cite-accessibility-label">Jump\ up\ to:\ </span>9.0](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_ref-MWG2010_9-0)</sup>
    <sup>[9.1](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#cite_ref-MWG2010_9-1)</sup></span>
    ...
    <a href="http://www.metadataworkinggroup.org/pdf/mwg_guidance.pdf" class="uri external free">http://www.metadataworkinggroup.org/pdf/mwg_guidance.pdf</a>
    </span></span>
...
[Classes](https://terms.tdwg.org/wiki/Special:Categories "Special:Categories"):

-   <a href="https://terms.tdwg.org/w/index.php?title=Class:Pages_using_duplicate_arguments_in_template_calls&amp;action=edit&amp;redlink=1" class="new" title="Class:Pages using duplicate arguments in template calls (page does not exist)">Pages using duplicate arguments in template calls</a>
-   [Audubon
    Core](https://terms.tdwg.org/wiki/Class:Audubon_Core "Class:Audubon Core")
...
-   <span
    id="pt-uls"><a href="https://terms.tdwg.org/wiki/Audubon_Core_Term_List#" class="uls-trigger autonym">English</a></span>
-   <span id="pt-login">[Log
    in](https://terms.tdwg.org/w/index.php?title=Special:UserLogin&returnto=Audubon+Core+Term+List "You are encouraged to log in; however, it is not mandatory [alt-shift-o]")</span>
-   <span id="pt-createaccount">[Request
    account](https://terms.tdwg.org/wiki/Special:RequestAccount "You are encouraged to create an account and log in; however, it is not mandatory")</span>
-   <span id="pt-openidlogin">[Use
    OpenID](https://terms.tdwg.org/w/index.php?title=Special:OpenIDLogin&returnto=Audubon_Core_Term_List)</span>

### Namespaces

-   <span
    id="ca-nstab-main">[Page](https://terms.tdwg.org/wiki/Audubon_Core_Term_List "View the content page [alt-shift-c]")</span>
-   <span
    id="ca-talk">[Discussion](https://terms.tdwg.org/w/index.php?title=Talk:Audubon_Core_Term_List&action=edit&redlink=1 "Discussion about the content page [alt-shift-t]")</span>

### Variants[](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#)

### Views

-   <span
    id="ca-view">[Read](https://terms.tdwg.org/wiki/Audubon_Core_Term_List)</span>
-   <span id="ca-form_edit">[View
    form](https://terms.tdwg.org/w/index.php?title=Audubon_Core_Term_List&action=formedit)</span>
-   <span id="ca-viewsource">[View
    source](https://terms.tdwg.org/w/index.php?title=Audubon_Core_Term_List&action=edit "This page is protected.
    You can view its source [alt-shift-e]")</span>
-   <span id="ca-history">[View
    history](https://terms.tdwg.org/w/index.php?title=Audubon_Core_Term_List&action=history "Past revisions of this page [alt-shift-h]")</span>

### More[](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#)

### Search

<a href="https://terms.tdwg.org/wiki/Main_Page" class="mw-wiki-logo" title="Visit the main page"></a>

### Terminology Platform

-   <span id="n-Terminology-Platform">[Terminology
    Platform](https://terms.tdwg.org/wiki/Main_Page)</span>

### [Navigation](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#)

-   <span
    id="n-help">[Help](https://terms.tdwg.org/wiki/Help:First_Help "The place to find out")</span>
-   <span id="n-Query-concepts">[Query
    concepts](https://terms.tdwg.org/wiki/Special:RunQuery/Query_concept)</span>
-   <span id="n-recentchanges">[Recent
    changes](https://terms.tdwg.org/wiki/Special:RecentChanges "A list of recent changes in the wiki [alt-shift-r]")</span>

### [Tools](https://terms.tdwg.org/wiki/Audubon_Core_Term_List#)

-   <span id="t-whatlinkshere">[What links
    here](https://terms.tdwg.org/wiki/Special:WhatLinksHere/Audubon_Core_Term_List "A list of all wiki pages that link here [alt-shift-j]")</span>
-   <span id="t-recentchangeslinked">[Related
    changes](https://terms.tdwg.org/wiki/Special:RecentChangesLinked/Audubon_Core_Term_List "Recent changes in pages linked from this page [alt-shift-k]")</span>
-   <span id="t-upload">[Upload
    file](https://species-id.net/openmedia/Special:UploadWizard?uselang=en "Upload files [alt-shift-u]")</span>
-   <span id="t-specialpages">[Special
    pages](https://terms.tdwg.org/wiki/Special:SpecialPages "A list of all special pages [alt-shift-q]")</span>
-   <span id="t-print">[Printable
    version](https://terms.tdwg.org/w/index.php?title=Audubon_Core_Term_List&printable=yes "Printable version of this page [alt-shift-p]")</span>
-   <span id="t-permalink">[Permanent
    link](https://terms.tdwg.org/w/index.php?title=Audubon_Core_Term_List&oldid=36898 "Permanent link to this revision of the page")</span>
-   <span id="t-info">[Page
    information](https://terms.tdwg.org/w/index.php?title=Audubon_Core_Term_List&action=info "More information about this page")</span>
-   <span id="t-smwbrowselink">[Browse
    properties](https://terms.tdwg.org/wiki/Special:Browse/Audubon_Core_Term_List)</span>
-   <span id="t-cite">[Cite this
    page](https://terms.tdwg.org/w/index.php?title=Special:CiteThisPage&page=Audubon_Core_Term_List&id=36898 "Information on how to cite this page")</span>

-   <span id="footer-info-lastmod">This page was last modified on 26
    September 2015, at 20:39.</span>
-   <span id="footer-info-copyright">Content is available under
    <a href="http://creativecommons.org/licenses/by-sa/4.0/" class="external">Creative Commons Attribution-Share Alike 4.0 Unported</a>.
    — This project is partly funded by the EU under grant agreement
    n°261532 [(ViBRANT)](http://terms.gbif.org/wiki/ViBRANT)</span>
...
-   <span id="footer-places-about">[About TDWG Terms
    Wiki](https://terms.tdwg.org/wiki/TDWG_Terms_Wiki:About "TDWG Terms Wiki:About")</span>
-   <span
    id="footer-places-disclaimer">[Disclaimers](https://terms.tdwg.org/wiki/TDWG_Terms_Wiki:General_disclaimer "TDWG Terms Wiki:General disclaimer")</span>
-   <span
    id="footer-places-developers">[Developers](https://www.mediawiki.org/wiki/Special:MyLanguage/How_to_contribute)</span>

<!-- -->

-   <span
    id="footer-copyrightico">[<img src="./term-list_files/CC-BY-SA_3_icon_88x31.png" alt="Creative Commons Attribution-Share Alike 4.0 Unported" width="88" height="31" />](http://creativecommons.org/licenses/by-sa/4.0/)</span>
-   <span
    id="footer-poweredbyico">[<img src="./term-list_files/Servedby_biowikifarm_88x31.png" alt="Served by Plazi Biowikifarm.net" width="88" height="31" />](http://biowikifarm.net/)[<img src="./term-list_files/Poweredby_mediawiki_64x31.png" alt="Powered by MediaWiki" width="64" height="31" />](http://www.mediawiki.org/)[<img src="./term-list_files/smw_button.png" alt="Powered by Semantic MediaWiki" width="88" height="31" />](https://www.semantic-mediawiki.org/wiki/Semantic_MediaWiki)</span>
