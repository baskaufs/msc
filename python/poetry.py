...
stopBy = Poem()
stopBy.text = frostText
stopBy.title = "Stopping by woods on a snowy evening"
stopBy.abuse('woods','swamp')
stopBy.abuse('horse','dragon')

stupid = Poem()
stupid.abuse('woods','swamp')
